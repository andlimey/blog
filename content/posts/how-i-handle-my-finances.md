...
Most will be placed in high-interest savings accounts or savings plans such as the Singlife insurance savings plan.

The rationale is that these funds should be liquid in the event that you need them urgently. Hence, it would be more prudent to avoid putting them in equities.
...
Admittedly, this may not be the most cost-efficient method. For those looking to invest via brokerages, [Interactive Brokers](https://www.interactivebrokers.com.sg/en/index.php?f=47341) recently removed their monthly inactivity fee, making them one of the most cost-efficient brokerages for retail investors with low AUMs.

**My portfolios for the different financial goals are divided accordingly:**
General investing (timeline is 20 years and longer)

-   Portfolio: Autowealth's 80-20 portfolio & Dimensional's World Equity Fund through Endowus
...
My main cashback car is the [UOB Absolute CashBack Card](https://www.uob.com.sg/personal/cards/credit-cards/rebates-cards/absolute-cashback.page) as they have the highest cashback rate at 1.7%. Additionally, there are no spend exclusions. i.e. You can use it to pay for your utilities and insurance premiums, which puts this card on top of the other cashback cards in the market.
