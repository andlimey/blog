...
According to Oxford Languages, the definition of insurance is:[^1]
...
Before I delve into that. Let’s first look at the types of insurance to consider. Since the primary purpose of insurance is to hedge against probable situations, some follow-up questions are:
...
Note: The recommended level of coverage is 3.9 times our annual income, according to LIA.[^5] It assumes you take 5 years to recover from a critical illness.
...
A TLDR:
| Type of Insurance | Duration of Coverage | Reason |
| ----------- | ----------- | ----------- |
| Death/Total Permanent Disability | Temporary | Income Replacement |
| Critical Illness | Temporary | Income Replacement |
| Health Insurance | Permanent | Expensive medical costs |
| Occupational Disability | Temporary | Income Replacement |
